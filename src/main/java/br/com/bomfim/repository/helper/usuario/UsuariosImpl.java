...
import br.com.bomfim.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries {
	...
	public Optional<Usuario> retrieveEmailAtivo(String email) {
		return entityManager.createQuery("from Usuario where lower(email) =:email and ativo= true", Usuario.class)
				.setParameter("email", email.toLowerCase()).getResultList().stream().findFirst();
	}
