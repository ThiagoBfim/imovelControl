...
Brewer.ComboCidade = (function() {
	...
	ComboCidade.prototype.iniciar = function() {
		...
		iniciarlizarCidades.call(this, codigoEstado);
	}
	...
	function iniciarlizarCidades(codigoEstado) {
		if (codigoEstado) {
			var resposta = $.ajax({
	...
	function onBuscarCidadesFinalizado(cidades) {
		...
		var codigoCidadeSelecioanda = this.inputHiddenCidadeSelecionada.val();
		if (codigoCidadeSelecioanda) {
			this.combo.val(codigoCidadeSelecioanda);
		}
	}
